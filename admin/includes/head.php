                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">New Requests</a>
                            <div class="dropdown-menu m-0">
                                <a href="user.php" class="dropdown-item">Public</a>
                                <a href="staff.php" class="dropdown-item">Staff</a>
                            </div>
                        </div>
						<div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Approved Users</a>
                            <div class="dropdown-menu m-0">
                                <a href="auser.php" class="dropdown-item">Public</a>
                                <a href="astaff.php" class="dropdown-item">Staff</a>
                            </div>
                        </div>
						<div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Rejected Users</a>
                            <div class="dropdown-menu m-0">
                                <a href="ruser.php" class="dropdown-item">Public</a>
                                <a href="rstaff.php" class="dropdown-item">Staff</a>
                            </div>
                        </div>

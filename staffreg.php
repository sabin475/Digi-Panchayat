...
if(isset($_POST['submit1']))
{
    ...
    $flag=0;
	//'$id','$sur','$name','$gender','$phno','$mailid','$dept','$post'
    ...
    if($flag==0)
    {
        ...
        $data="SELECT * FROM sreg natural join login";
        $c=0;
        $sd="SELECT * FROM sreg";
        ...
        {
            if($row['smailid']==$mailid||$row['sphno']==$phno)
            {
                $flag=1;
            }
        }
        ...
        {
            $sql="INSERT INTO `sreg`VALUES ('$id','$sur','$name','$gender','$phno','$mailid','$post')";
            if(mysql_query($sql,$con))
            {
                $sql1="INSERT INTO `login`VALUES ('$mailid','$password','staff',0)";
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="section-title position-relative text-center mb-5 pb-2 wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <h2 class="mt-2">Registration for Staff's</h2>
                        </div>
                            ...
                            <form action="" method="POST">
                               <table id="customers">
								...
								<tr><td>Gender</td><td><select name="gender"><option>- Select Gender -</option>
								 ...
								 <tr><td>Post</td><td><input type="text" name="post" pattern='[a-zA-Z]{3,30}' title="Minimum 3 & maximum 30 characters. Letters only permitted."required></td></tr>
